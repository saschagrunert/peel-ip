...
static PACKET: &'static [u8] = &[0x08, 0x00, 0x41, 0x5c, 0x02, 0x00, 0x0a, 0x00, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66,
...
#[bench]
fn icmp_small_packet(bencher: &mut Bencher) {
...
#[bench]
fn icmp_big_packet(bencher: &mut Bencher) {
    let mut parser = IcmpParser;
